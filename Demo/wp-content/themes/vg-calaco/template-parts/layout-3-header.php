				...
				<div class="container">
					<div class="row">
						...
						<?php if(is_active_sidebar('topbar-2')) : ?>
							<div class="col-md-<?php echo(is_active_sidebar('topbar-3')) ? '6 text-right' : '12 text-center'; ?> col-sm-6 col-xs-12 col-topbar">
			...
			<div class="header home3">
				<div class="container">
					<div class="row">
						...
						<div id="navigation" class="col-xs-12 col-md-<?php echo(is_active_sidebar('vg-header-static')) ? '7' : '12'; ?>">
						...
						<?php if(is_active_sidebar('vg-header-static')) : ?>
							<div class="col-xs-12 col-md-2 free-call-us">
								<div class="call-inside">
									<?php dynamic_sidebar('vg-header-static'); ?>
								</div>
				...
				<div class="container">
					<div class="row">
						...
						<?php if(is_active_sidebar('vg-search-widget')) : ?>
							<div class="col-xs-12 col-md-<?php echo(is_active_sidebar('vg-header-static')) ? 7 : 9; ?> col-sm-8 search-wrap home3">
						...
						<div class="col-xs-12 col-md-<?php echo(is_active_sidebar('vg-search-widget')) ? 2 : 6; ?> col-sm-4 ecommerce-wrap home3">
