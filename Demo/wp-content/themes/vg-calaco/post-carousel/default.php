			...
			{ 
				...
				$return_content .= '<div class="item-i">';
					...
					$return_content .= '<div class="post-content">';
						...
						$return_content .= '<div class="post-content">'. get_the_excerpt() .'</div>';
					
						$return_content .= '<div class="post-readmore"><a href="'. esc_url(get_permalink()) .'">'. esc_html__("Read More &raquo;", "vg-calaco") .'</a></div>';
					$return_content .= '</div>';
				$return_content .= '</div>';
			}
