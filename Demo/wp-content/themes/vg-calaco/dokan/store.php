				...
				<div class="dokan-widget-area widget-collapse">
					...
					if ( ! dynamic_sidebar( 'sidebar-store' ) ) {
						...
						if ( class_exists( 'Dokan_Store_Location' ) ) {
							the_widget( 'Dokan_Store_Category_Menu', array( 'title' => esc_html__( 'Store Category', 'vg-calaco' ) ), $args );

							if ( dokan_get_option( 'store_map', 'dokan_general', 'on' ) == 'on' ) {
								the_widget( 'Dokan_Store_Location', array( 'title' => esc_html__( 'Store Location', 'vg-calaco' ) ), $args );
							}

							if ( dokan_get_option( 'contact_seller', 'dokan_general', 'on' ) == 'on' ) {
								the_widget( 'Dokan_Store_Contact_Form', array( 'title' => esc_html__( 'Contact Vendor', 'vg-calaco' ) ), $args );
							}
						}
		...
		<div id="dokan-primary" class="dokan-single-store dokan-w8">
			<div id="dokan-content" class="store-page-wrap woocommerce" role="main">
				...
				<?php } else { ?>
					...
					<p class="dokan-info"><?php echo esc_html__( 'No products were found of this vendor!', 'vg-calaco' ); ?></p>
