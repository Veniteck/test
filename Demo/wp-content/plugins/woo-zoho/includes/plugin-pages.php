...
if(!empty($v['placeholder'])){ $label=$v['placeholder']; }
  ...
  $ship_fields_wc= WC()->countries->get_address_fields('us','_shipping_' );
...
if(isset($v['placeholder'])){ $label=$v['placeholder']; }
 ...
 $user=array('__vx_wp-user_login'=>array('label'=>'user_login'),'__vx_wp-ID'=>array('label'=>'user_id')
  ...
  $tx_arr=array();
  $prpduct_attrs=array('name'=>'Product Name','description'=>'Product Description','short_description'=>'Short Description','sku'=>'Product SKU','price'=>'Product Price','regular_price'=>'Product Regular Price','sale_price'=>'Product Sales Price','total_sales'=>'Product Total Sales','stock_quantity'=>'Stock Quantity','weight'=>'Product Weight','length'=>'Product Length','product_cats'=>'Product Category Slugs');
