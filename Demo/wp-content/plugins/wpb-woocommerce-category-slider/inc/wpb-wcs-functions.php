...
function wpb_wcs_pro_discount_admin_notice() {
    ...
    if ( !get_user_meta( $user_id, 'wpb_wcs_pro_discount_dismissed' ) ){
        printf('<div class="wrap"><div class="wpb-wcs-discount-notice" style="padding-bottom: 15px;padding-top: 8px;background: #fff;padding: 20px 15px;margin-top: 20px;box-shadow: 0 1px 1px rgba(0,0,0,.04);border: 1px solid #ccd0d4;border-left-width: 4px;border-left-color: #00a0d2;"><p>%s <a target="_blank" href="%s">%s</a>! %s <b>%s</b></p><a href="%s">%s</a></div></div>', esc_html__( 'Get a 10% exclusive discount on the premium version of the', WPB_WCS_TEXTDOMAIN ), 'https://wpbean.com/downloads/wpb-woocommerce-category-slider-pro/', esc_html__( 'WPB Product Categories Slider for WooCommerce', WPB_WCS_TEXTDOMAIN ), esc_html__( 'Use discount code - ', WPB_WCS_TEXTDOMAIN ), '10PERCENTOFF', esc_url( add_query_arg( 'wpb-wcs-pro-discount-admin-notice-dismissed', 'true' ) ), esc_html__( 'Dismiss', WPB_WCS_TEXTDOMAIN ));
    }
}
